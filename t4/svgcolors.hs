...
-- Combina (zip) a lista de estilos com a lista de retangulos, aplicando os estilos ciclicamente. -- Se houverem mais retangulos que cores, havera retangulos com cores repetidas. -- Se houverem menos retangulos que cores, algumas cores nao serao usadas.
...
--Gera cores para os retangulos de acordo com o valor de n.
styles :: Int -> [String]
styles n = ["fill:rgb("++ (show n) ++",0,0)","fill:rgb(0,"++(show n) ++",0)"] 
...
-- styles = ["fill:rgb(140,0,0)","fill:rgb(0,140,0)"] -- Estilo: vermelho e verde
   rectstyles = applyStyles (styles 550) rects
